...
| **DC Runner x.1 / x.2 / x.3** (Rückförderpumpe) | ✅ Unterstützt |
...
|-------|--------|------------|
| **ReefDose** (RSDOSE2/4) | ✅ Implementiert | Vollständige Planung, manuales Dosieren, Priming/Kalibrierung, Supplement-Verwaltung, Nutzungsverfolgung |
